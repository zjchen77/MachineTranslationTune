...
'''def calcule_bleu():
    with open("/home/zhangcw/zjchen/en-ch-NMT/bleu_sentences.txt",'r') as f:
    ...
    predicts = tokenizer.batch_decode(generated_ids, skip_special_tokens=True)
    with open("bleu_test_opus.txt",'a+',encoding='utf8') as f:
        for i in range(len(sentences)):
            f.write('\n'.join([sentences[i],labels[i],predicts[i]]) + "\n\n")
